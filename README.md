...
Chromium based browsers are having issues with clearing the full cache. They're honoring CacheExpires times even after the cache has been deleted, and attempting to redownload old files that no longer exist. They've taken the cacheing too far.
